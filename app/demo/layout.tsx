...
export const metadata: Metadata = {
  ...
  description: "Scan any URL for child safety with KOMAL's free AI-powered tool. Check if websites are safe for kids with our content analyzer. Instant results for parents and educators.",
  ...
  openGraph: {
    title: "Free URL Safety Scanner for Kids | KOMAL",
  ...
  twitter: {
    ...
    title: "Free Child Safety URL Scanner | KOMAL",
