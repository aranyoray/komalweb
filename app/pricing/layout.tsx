...
export const metadata: Metadata = {
  ...
  description: "Affordable child internet safety plans starting free. AgileWeb parental control app pricing for families, schools, and therapy centers. Protect your children online with AI-powered content filtering.",
  ...
  openGraph: {
    title: "AgileWeb Pricing | Child Internet Safety Plans",
  ...
  twitter: {
    card: "summary",
    title: "AgileWeb Pricing Plans | Child Safety App",
